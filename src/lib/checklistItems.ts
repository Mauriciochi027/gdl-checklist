...
export const checklistItems: ChecklistItem[] = [
  ...
  { id: "1", category: "Segurança", description: "Status do cinto de segurança", required: true },
  ...
  { id: "7", category: "Freios e Direção", description: "Status do freio", required: true },
  { id: "8", category: "Pneus e Rodas", description: "Condições do pneu/roda", required: true },
  ...
  { id: "12", category: "Segurança", description: "Extintor", required: true },
  { id: "13", category: "Iluminação", description: "Status dos faróis", required: true },
  { id: "14", category: "Garfos e Mastro", description: "Status da torre e corrente", required: true },
